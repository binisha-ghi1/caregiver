      ...
      <section className="bg-[#e6f7f7] py-16 px-6 md:px-20 text-center flex-wrap">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
            Ready to start your care journey? We're here to answer your
            questions and <br className="hidden md:block" />
          ...
          <div className="flex flex-col justify-between h-full space-y-6">
            <div>
              ...
              <p className="text-gray-700 mt-2">
                We're available 24/7 for care services and our office team is
                ready to help you during business hours.
              </p>
            </div>
      ...
      <section className="bg-[#f0faff] py-16 px-6 md:px-20 text-center">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <p className="text-gray-600 text-lg">
            Meet with our care coordinators to discuss your needs and create a
            personalized care plan. <br className="hidden md:block" />
            No obligation, just honest guidance to help you make the best
            decisions.
          </p>
