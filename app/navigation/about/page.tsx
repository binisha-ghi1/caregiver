    ...
    <>
      ...
      <section className="bg-[#daf7f2] py-16 px-6 md:px-20 text-center flex-wrap">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
            Dedicated to providing exceptional, compassionate care that allows your loved ones to <br className="hidden md:block" />
      ...
      <section className="flex flex-col lg:flex-row items-center bg-white justify-between gap-10 px-6 md:px-20 py-16">
        ...
        <div className="max-w-xl text-center lg:text-left">
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">
            At CareHeart, we believe that everyone deserves to age with dignity, comfort,
            and independence. Our mission is to provide personalized, professional care
            services that enhance quality of life while giving families peace of mind.
          </p>
          <p className="text-gray-700 mb-6 leading-relaxed">
            Founded in 2014, we've grown from a small local service to a trusted care
            provider, always maintaining our core values of compassion, respect, and
      ...
      <section className="flex flex-col md:flex-row justify-center items-center bg-white py-12 gap-8">
        {ValueHighlights.map((item, index) => (
          <div key={index} className="flex flex-col items-center text-center px-6 max-w-xs">
