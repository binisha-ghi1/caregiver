...
const careServices = [
  { icon: Handshake, title: 'Socialization', desc: 'Friendship and support for seniors' },
  { icon: Dice6, title: 'Medication Management', desc: 'Scheduled medication assistance' },
  { icon: FaUserNurse, title: 'Care Management', desc: 'Help with overall care coordination' },
  { icon: RiClapperboardLine, title: 'Personal Hygiene', desc: 'Bathing, dressing, grooming' },
  { icon: Bike, title: 'Safe Transportation', desc: 'Rides from home to appointments' },
  { icon: IceCreamBowl, title: 'Meal Preparation', desc: 'Grocery shopping & cooking' },
  { icon: BrushCleaning, title: 'Housekeeping Services', desc: 'Laundry & cleaning tasks' },
  { icon: MapPin, title: 'Quick Rides', desc: 'To different locations or checkups' },
];
    ...
    <div>
      ...
      <section className="bg-[#daf7f2] px-4 md:px-20 py-14 text-center text-black">
        ...
        <p className="text-gray-600 mb-8 max-w-3xl mx-auto">
          Comprehensive care services designed to help your loved ones maintain their independence
      ...
      <section className="p-4 md:px-20 py-14 bg-white">
        <h2 className="text-4xl font-bold text-center text-black mb-10">Core Services We Offer</h2>
